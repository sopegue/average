  ...
  <div class="px-5 py-5 w-full">
    <div class="flex flex-col space-y-8">
      <div class="flex justify-center font-semibold border-b pb-3">
        <span class="text-center">Simulate my average's origin</span>
      </div>
      <div
        v-if="!hasData"
      ...
      >
        <div class="flex sm:flex-row flex-col sm:space-x-20">
          <div class="flex w-fit mx-auto items-center flex-col space-y-3">
            <div class="flex space-x-3">
              <div class="flex flex-col space-y-2 items-center">
                <span class="w-fit text-sm">My average</span>
                <input
                  v-model="avg"
                  type="text"
                  :class="{
              ...
              <div class="flex flex-col space-y-2 items-center">
                <span class="w-fit text-sm">Total</span>
                <input
                  v-model="total"
                  type="text"
                  :class="{
          ...
          >
            <span class="w-fit text-sm">Number of subject(s)</span>
      ...
      <div v-for="(j, i) in +nbr" :key="i" class="w-fulls pb-4 border-b">
        ...
        >
          <div class="w-fulls flex flex-col space-y-1">
            <span class="text-sm italic">Subject {{ i + 1 }}</span>
            <input
          ...
          <div class="sm:w-56 flex space-x-6">
            <div class="flex flex-col space-y-2 items-center">
              <span class="text-sm italic">Mark</span>
            ...
            <div class="flex flex-col space-y-2 items-center">
              <span class="text-sm italic">Factor</span>
              <input
                :id="'coef' + i"
